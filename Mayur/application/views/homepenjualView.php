...
<body>
	...
	<div class="box">
			...
			<div style="display: flex; flex-direction: column; margin-top: 5%; margin-left: 5%;" type="button" onclick="window.location='<?php echo base_url()?>grupController/index';">
				<div class="content">
					<div style="display: flex; flex-direction: row;">
						<img src="<?php echo base_url();?>assets/img/cart.png" class="imageContent">
						<p class="textContent">
							<b>Anda memiliki 5 grup</b> 
						</p>
					</div>
				</div>
			</div>
